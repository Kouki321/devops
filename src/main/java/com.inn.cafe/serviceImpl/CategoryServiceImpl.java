        ...
        try{
            if(jwtFilter.isAdmin()){
                if(validateCategoryMap(requestMap,true)){
                    ...
                    return CafeUtils.getResponeEntity("Category Added suceesfully", HttpStatus.OK);
                }
            }else {
                return CafeUtils.getResponeEntity(CafeConstants.UNAUTHORIZED_ACCESS, HttpStatus.INTERNAL_SERVER_ERROR);
            }
        }catch (Exception ex){
            ex.printStackTrace();
        }
